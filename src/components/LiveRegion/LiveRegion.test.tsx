  ...
  function TestAnnouncer() {
    ...
    return (
      <>
        ...
        <button onClick={() => announce('Message one')} data-testid="btn1">Button 1</button>
        <button onClick={() => announce('Message two')} data-testid="btn2">Button 2</button>
        <button onClick={() => announce('Disappearing')} data-testid="temp">Temp</button>
      </>
    )
  }
